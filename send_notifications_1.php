...
<body style="background-color: #c1e6a4;"> <!-- Add inline style to set background color -->
    ...
    <div class="container">
        ...
        function sendEmail($to, $subject, $message) {
            $mjApiKey = '82559e367bfe8943cc05bab1e294c334';
            $mjApiSecret = '931262d3e2f4fc005a85614c0efcc77a';
            ...
            $response = $client->post('send', [
                'json' => [
                    'Messages' => [
                        [
                            'From' => [
                                'Email' => 'anikafariha025@gmail.com',
                                'Name' => 'FitStudio',
                            ],
                            'To' => [
                                [
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (emailsAlreadySentToday()) {
                ...
                // Query to select admin email FIRST ONE
                $sql_admin = "SELECT a_email FROM Admin LIMIT 1";
